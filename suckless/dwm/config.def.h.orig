...
static const char *fonts[]          = { "Jetbrains Mono:size=12:antialias=true:autohint=true", "FontAwesome:style=Regular:size=12:antialias=true:autohint=true" };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_p,      setlayout,      {.v = &layouts[2]} },
